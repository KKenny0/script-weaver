...
def main() -> int:
    with tempfile.TemporaryDirectory() as directory:
        ...
        require("script-weaver-episode-map" in skill_text, "Script Weaver episode map contract")
        require('"story"' in skill_text and "fingerprint" in skill_text, "episode story fingerprint contract")
